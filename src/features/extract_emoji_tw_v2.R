#########################################################################
#    File_name: extract_emoji_tw_v2.R
...
#             REDO analysis using just e-tweets with party affiliations
#    Input_files: filtered.csv, full_emoji_db.csv
#    Output_files: emoji_counts_v2.csv
...
tweets <- tweets[, c("X", "text.x")]
names(tweets) <- c("X", "text")
...
# Creating outputs  -------------------------------------------------------
write.csv(emoji_c, "data/interim/emoji_counts_v2.csv")
